...
class JiraBackend(models.Model):
    ...
    def _get_app_descriptor(self) -> dict:
        self.ensure_one()
        base_url = self._get_base_url()
        bcknd_id = self.id
    ...
    def _uses_gdpr_strict_mode(self) -> bool:
        """Defines whether JIRA's GDPR strict mode is active

        Hook method, can be overridden.
        ``True`` by default for security reasons.
        """
        return True
